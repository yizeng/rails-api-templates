...
Airbrake.configure do |c|
  ...
  c.project_id = ENV.fetch("AIRBRAKE_PROJECT_ID", "project_id")
  c.project_key = ENV.fetch("AIRBRAKE_PROJECT_KEY", "project_key")
  ...
  c.environment = ENV.fetch("AIRBRAKE_ENV", Rails.env)
